...
import modules.sql.userinfo_sql as sql
...
from modules.sql.users_sql import get_user_num_chats
            ...
            message.reply_photo(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "ᴄʜᴀɴɴᴇʟ", url="https://t.me/BeatAnime"
                            ),
                            InlineKeyboardButton(
                                "ᴅɪsᴄᴜssɪᴏɴ", url="https://t.me/Beat_Anime_Discussion"
                            ),
                        ],
                    ]
                ),
