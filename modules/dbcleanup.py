...
import modules.sql.global_bans_sql as gban_sql
import modules.sql.users_sql as user_sql
from beataniversebot_compat import DEV_USERS, OWNER_ID, dispatcher
