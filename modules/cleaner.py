# ====================================================================
# PLACE AT: /app/modules/cleaner.py
...
from beataniversebot_compat import ALLOW_EXCL, CustomCommandHandler, dispatcher
...
from modules.sql import cleaner_sql as sql
